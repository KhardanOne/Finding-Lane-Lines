...
def abs_sobel_thresh(img, orient='x', thresh_min=0, thresh_max=255):
    ...
    img_sobel_float = cv2.Sobel(img_gray, cv2.CV_64F, deriv[0], deriv[1])
    ...
    binary_output[(img_scaled_sobel >= thresh_min) & (img_scaled_sobel <= thresh_max)] = 1
...
# Run the function
grad_binary = abs_sobel_thresh(image, orient='x', thresh_min=25, thresh_max=255)
# Plot the result
